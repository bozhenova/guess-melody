type State = { level: number, lives: number, time: number, result?: number, answers: { result: boolean, answerTime: number, type: string }[] };
...
export { INITIAL_STATE, State, GAME_SETTINGS, Settings, GameData, QUESTIONS };